...
One record per seat, e.g. `context/current/seats/mayor.md` — a copy of the seat's identity plus a short history log: achievements, laurels, notable landings. Keep it current; move superseded records to `archive/` when a seat's history is closed.
